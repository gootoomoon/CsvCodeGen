...
namespace fastJSON
{
    ...
    public sealed class Reflection
    {
		...
		{
			return new GenericSetter((target, value) =>
			{
		...
		{
            if (type.GetInterface("IMemberAccessor") != null)
            {
                return new GenericSetter((target, value) =>
                {
                    (target as IMemberAccessor).SetValue(target, propertyInfo.Name, value);
                    return target;
                });
            }
		...
		{
			return new GenericGetter((target) =>
			{
		...
		internal static GenericGetter CreateGetMethod(Type type, PropertyInfo propertyInfo)
		{
            if (type.GetInterface("IMemberAccessor") != null)
            {
                return new GenericGetter((target) =>
                {
                    return (target as IMemberAccessor).GetValue(target, propertyInfo.Name);
