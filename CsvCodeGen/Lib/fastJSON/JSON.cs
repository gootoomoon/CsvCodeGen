...
namespace fastJSON
{
    ...
    public sealed class JSONParameters
    {
        ...
        /// </summary>
        public bool UseOptimizedDatasetSchema = false;
        /// <summary>
    ...
    public static class JSON
    {
        ...
        /// <param name="json"></param>
        /// <returns></returns>
        public static object FillObject(object input, Dictionary<string, object> ht)
        {
            return new deserializer(Parameters).ParseDictionary(ht, null, input.GetType(), input);
        }
    ...
    internal class deserializer
    {
        ...
        public object ToObject(string json, Type type)
        {
            ...
            if (o is List<object>)
            {
                ...
                if (type != null && t.BaseType != null && t.BaseType.Name == typeof(List<>).Name) // deserialize to generic list
                    return RootList(o, type);
                        ...
                        switch (pi.Type)
                        {
                            ...
                            case myPropInfoType.Enum:
                                if (v is string)
                                    ...
                                    oset = CreateEnumByObject(pi.pt, v);
                                break;
        ...
        private object CreateEnumByObject(Type pt, object v)
        {
